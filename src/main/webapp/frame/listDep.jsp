...
<table border="0" width="900px">
    ...
    <tr>
        <td align="right" > <a href="${pageContext.request.contextPath}/department_addShow.action">添加</a></td>
    </tr>
</table>
<br/>
    ...
    <tbody>
        <s:iterator value="list" var="d">
            <tr>
                ...
                <td align="center"><a href="${pageContext.request.contextPath}/department_delete.action?did=<s:property value="#d.did"/>" onclick="javascript:return confirm('是否确定删除？')">删除</a></td>
            </tr>
        </s:iterator>
    </tbody>
</table>
