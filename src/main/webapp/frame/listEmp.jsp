...
<table border="0" width="900px">
    ...
    <tr>
        <td align="right" > <a href="${pageContext.request.contextPath}/employee_addShow.action">添加</a></td>
    </tr>
</table>
<br/>
    ...
    <tbody>
        <s:iterator value="list" var="e">
            <tr>
                ...
                <td align="center"><a href="${pageContext.request.contextPath}/employee_delete.action?eid=<s:property value="#e.eid"/>" onclick="javascript:return confirm('是否确定删除？')">删除</a></td>
            </tr>
        </s:iterator>
    </tbody>
</table>
